...
class TopicRankCompressor:
    ...
    def _build_topic_graph(self, chunks: List[str], query: Optional[str] = None) -> nx.Graph:
        """构建主题图
    ...
    def _calculate_topic_scores(self, chunks: List[str], query: Optional[str] = None) -> np.ndarray:
        """计算主题得分
